...
# get_campaign = '%s/SmiddleCampaignManager/cm/mgr/get_campaign' % server
# get_batch = '%s/SmiddleCampaignManager/cm/mgr/get_batch' % server
...
# get_result_code = '%s/SmiddleCampaignManager/cm/mgr/get_result_code' % server
# edit_batch = '%s/SmiddleCampaignManager/cm/mgr/edit_batch' % server
# get_mapfields = '%s/SmiddleCampaignManager/cm/settings/get_mapfields' % server
# edit_result_code = '%s/SmiddleCampaignManager/cm/mgr/edit_result_code' % server
# get_result_variants = '%s/SmiddleCampaignManager/cm/mgr/get_result_variants' % server
# edit_result_variant = '%s/SmiddleCampaignManager/cm/mgr/edit_result_variant' % server
# map_field = '%s/SmiddleCampaignManager/cm/settings/map_field' % server
# edit_campaign = '%s/SmiddleCampaignManager/cm/mgr/edit_campaign' % server
...
# remove_result_code = '%s/SmiddleCampaignManager/cm/mgr/remove_result_code' % server
...
# delete_campaign = '%s/SmiddleCampaignManager/cm/mgr/delete_campaign' % server
# remove_result_variant = '%s/SmiddleCampaignManager/cm/mgr/remove_result_variant' % server
#
