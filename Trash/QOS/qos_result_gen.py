...
for group in groups:
    data_calls = json.dumps({"dateFrom":1500930000000,"dateTo":1501102800000, "showUnmappedCalls": False, "groupId":"%s"%group,
                             "pagination": {"page_number": "1", "page_size": count_of_results, "sortedField": "dateStart",
                                            "order": "ASC"}})
    data_empty_result = {"templateId": 217927458, "userId": 2, "callIds": [141385835]}
