...
class Test_Routes:
    ...
    def test_add_route(self, send_request, clear_result):
    ...
    def test_add_route_with_unknown_internalNumber(self, send_request):
        url = URL.fixed_routes
        # Подготавливаем данные в JSON для запроса
    ...
    def test_add_route_with_existing_externalNumber(self, add_route, send_request):
        url = URL.fixed_routes
    ...
    def test_delete_route(self, add_route, send_request):
        url = URL.fixed_routes
        params = {'id':add_route['id']}
        # Делаем запрос и получаем ответ
        response = send_request(url, method = 'DELETE', params = params)
        answer = add_route['id']
        assert response.status_code == 200
        assert answer == response.json()
    ...
    def test_delete_route_with_unknown_id(self, send_request):
        url = URL.fixed_routes
        # Делаем запрос и получаем ответ
        response = send_request(url, method = 'DELETE',  params = {'id':999999999})
    ...
    def test_put_route_internalNumber_externalNumber_callDate(self, add_route, send_request):
        url = URL.fixed_routes
        # Делаем запрос и получаем ответ
    ...
    def test_get_route_with_invalid_pagination(self, add_route, send_request):
        url = URL.fixed_routes
        # Делаем запрос и получаем ответ
    ...
    def test_get_route_with_unknown_agnetnumber(self, add_route, send_request):
        url = URL.fixed_routes
        # Делаем запрос и получаем ответ
    ...
    def test_put_route_with_unknown_id(self, add_route, send_request):
        url = URL.fixed_routes
    ...
    def test_put_route_externalNumber_internalNumber_on_existing(self,add_route, send_request, clear_result):
        url = URL.fixed_routes
        # Подготавливаем данные в JSON для запроса
        data = _.get_JSON_request('add_route', **{"internalNumber": "1111",
...
class Test_Settings:
    ...
    def get_settings(self, send_request):
        response = send_request(URL.scb_settings, method="GET")
        assert response.status_code == 200
        yield response.json()

        #Востанавливаем настройки которые были до теста
        response = send_request(URL.scb_settings, method="PUT", data = response.json())
        assert response.status_code == 200

    @allure.feature('Позитивный тест')
    @allure.story('Получаем манифест')
    def test_manifest(self, send_request):
        response = send_request(URL.scb_manifest, method = "GET")
    ...
    def test_licenses(self, send_request):
        response = send_request(URL.scb_licenses, method = "GET")
    ...
    def test_count(self, send_request):
        response = send_request(URL.scb_count, method = "GET",)
        assert response.status_code == 200


    @allure.feature('Позитивный тест')
    @allure.story('Получаем настройки')
    def test_settings(self, send_request):
        response = send_request(URL.scb_settings, method="GET")
    ...
    def test_edit_settings(self,get_settings, send_request, debugLevel, logLength,monitoring,smartLabel,routing):
        data = _.generate_JSON(get_settings, {"debugLevel": debugLevel,
                                                     "logLength": logLength,
                                                     "monitoring": monitoring,
                                                     "smartLabel": smartLabel,
                                                     "routing": routing})
        response = send_request( URL.scb_settings, data, method="PUT")
        answer = data
        assert response.status_code == 200
    ...
    def test_edit_settings_with_unknown_id(self,get_settings, send_request):
...
class Test_Contact():
    ...
    def test_add_contact_with_valide_data(self, send_request, clear_result, phoneType):
        url = URL.scb_contact
    ...
    def test_add_contact_with_fName_lName_is_None(self, send_request):
        url = URL.scb_contact
    ...
    def test_add_contact_with_phoneNumber_is_null(self, send_request):
        url = URL.scb_contact
        payload = _.get_JSON_request('add_contact', **{"fName": "Victor1",
                                                        "lName": "Kliui1",
                                                        "phoneNumber": None,
    ...
    def test_add_contact_with_incorrect_phoneType(self, send_request):
        url = URL.scb_contact
        payload = _.get_JSON_request('add_contact', **{"fName": "Victor1",
                                                        "lName": "Kliui1",
                                                        "phoneNumber": None,
    ...
    def test_add_contact_without_phones(self, send_request, clear_result):
        url = URL.scb_contact
        payload = _.get_JSON_request('add_contact', **{"fName": "Victor1",
                                                        "lName": "Kliui1",
                                                        "phones":None})
    ...
    def test_get_contact(self, send_request, add_contact):
        url = URL.scb_contact
    ...
    def test_delete_contact(self, send_request, add_contact):
        url = URL.scb_contact
        contact_id = add_contact['id']
        response = send_request(url, method = "DELETE",  params = {'id':contact_id})
        answer = contact_id
        assert response.status_code == 200
        assert response.json() == answer
    ...
    def test_delete_contact_with_unknown_id(self, send_request):
        url = URL.scb_contact
        response = send_request(url, method = "DELETE",  params = {'id':999999999})
    ...
    @pytest.mark.parametrize('phoneType',['MOBILE', 'HOME', 'WORK'])
    def test_edit_contact_with_valide_data(self, send_request, add_contact, phoneType):
        url = URL.scb_contact
    ...
    def test_edit_contact_with_FIO_and_phoneNumber_is_null(self, send_request, add_contact):
        url = URL.scb_contact
    ...
    def test_edit_contact_with_unknown_id(self, send_request, add_contact):
        url = URL.scb_contact
    ...
    def test_edit_contact_phone_with_unknown_phone_id(self, send_request, add_contact):
        url = URL.scb_contact
        #Изменяем id телефона
        add_contact['phones'][0]['id'] = 999999999
        response = send_request(url, method = "PUT",  data=add_contact)
        assert response.status_code == 500
...
class Test_Credential:
    ...
    def test_add_credentials_with_valide_data(self, send_request, clear_result):
        url = URL.scb_credentials
        credential = get.credentials
        response = send_request(url, data=credential)
    ...
    def test_delete_credentials_with_valide_id(self, send_request, add_credential):
        url = URL.scb_credentials
        credential_id = {'id': add_credential['id']}
        response = send_request(url, method = 'DELETE',  params=credential_id)
        assert response.status_code == 200
    ...
    def test_delete_credentials_with_unknown_id(self, send_request, add_credential):
        url = URL.scb_credentials
