...
class Tests_add_user:
    ...
    def test_Positive_add_one_user(self, make_request, delete_user):
        # Подготавливаем данные в JSON для запроса
        data = _.get_JSON_request(self.name, **{"fname": "add_user_fName_one",
        ...
        answer = _.get_JSON_response(self.name, **{'id': user_id,
    ...
    def test_add_user_with_existing_FIO(self, make_request, delete_user, add_delete_user):
        # Подготавливаем данные в JSON для запроса
        add_delete_user(get.add_user_existing)
        data = _.get_JSON_request(self.name, **{"fname": "add_user_fName_existing",
    ...
    def test_add_user_with_existing_email_fax_loginAD(self, make_request, delete_user, add_delete_user):
        # Подготавливаем данные в JSON для запроса
        add_delete_user(get.add_user_existing)
        data = _.get_JSON_request(self.name, **{"fname": "add_user_fName_one",
                                           "lname": "add_user_lName_one",
    ...
    @pytest.mark.xfail
    def test_add_user_with_existing_login(self, make_request, add_delete_user):
        # Подготавливаем данные в JSON для запроса
        add_delete_user(get.add_user_existing)
        data = _.get_JSON_request(self.name, **{"fname": "add_user_fName_one",
                                           "lname": "add_user_lName_one",
    ...
    def test_add_user_with_existing_loginId(self, make_request, add_delete_user):
        # Подготавливаем данные в JSON для запроса
        add_delete_user(get.add_user_existing)
        data = _.get_JSON_request(self.name, **{"fname": "add_user_fName_one",
                                           "lname": "add_user_lName_one",
        ...
        # Данные которые должны быть в ответе
        answer = {
            "COMMON_ENTITY_WITH_SUCH_FIELD_EXISTS": "CommonEntityWithSuchFieldExists: AGENT ID =add_user_agentId_existing already exists"}
        assert response.status_code == 500
        assert answer == response.json()

    @allure.feature('Негативный тест')
    @allure.story('Добавляем пользователя с существующим phone')
    def test_add_user_with_existing_phone(self, make_request, add_delete_user):
        # Подготавливаем данные в JSON для запроса
        add_delete_user(get.add_user_existing)
        data = _.get_JSON_request(self.name, **{"fname": "add_user_fName_one",
                                           "lname": "add_user_lName_one",
    ...
    def test_add_user_with_existing_FIO_phone_loginAD_agentId_deleted_user(self, make_request, delete_user, add_delete_user):
        # Подготавливаем данные в JSON для запроса
        add_delete_user(get.add_user_deleted_existing)
        data = _.get_JSON_request(self.name, **{"fname": "add_user_fName_deleted_existing",
    ...
    def test_add_one_user_without_data(self, make_request):
        # Подготавливаем данные в JSON для запроса
        data = _.get_JSON_request(self.name, **{"groups": None,
                                           "roles": None,
                                           "email": "aaaaaaaaaaaaa"})
    ...
    @pytest.mark.xfail
    def test_add_one_user_without_login(self, make_request):
        # Подготавливаем данные в JSON для запроса
        data = _.get_JSON_request(self.name, **{"fname": "add_user_fName_deleted_existing",
                                           "lname": "add_user_lName_deleted_existing",
                                           "pname": "add_user_pName_deleted_existing",
